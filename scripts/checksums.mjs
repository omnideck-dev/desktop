// Writes a `<artifact>.sha256` file next to every installer under a bundle
// directory. Ported from the sibling repo's scripts/checksums.mjs — used by
// the release job to publish verifiable checksums alongside each installer.
